import type { CreateReservationRequest, UpdateReservationRequest, Reservation } from "../types/reservation.types"
...
export async function createReservationAction(payload: CreateReservationRequest): Promise<Reservation> {
  return reservationsApi.create(payload)
}

export async function updateReservationAction(id: number, payload: UpdateReservationRequest): Promise<Reservation> {
