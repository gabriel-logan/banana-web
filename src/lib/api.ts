...
export const authApi = {
  ...
  register: (payload: RegisterRequest) =>
    authHttp.post<AuthResponse>("/api/auth/register", payload).then((r) => r.data),
}

export const branchesApi = {
  getAll: () =>
    reservationsHttp.get<Branch[]>("/branches").then((r) => r.data),
}

export const roomsApi = {
  getAll: () =>
    reservationsHttp.get<Room[]>("/rooms").then((r) => r.data),
}
...
export const reservationsApi = {
  ...
  getById: (id: string) =>
    reservationsHttp.get<Reservation>(`/reservations/${id}`).then((r) => r.data),

  create: (payload: CreateReservationRequest) =>
    reservationsHttp.post<Reservation>("/reservations", payload).then((r) => r.data),

  update: (id: number, payload: UpdateReservationRequest) =>
    reservationsHttp.put<Reservation>(`/reservations/${id}`, payload).then((r) => r.data),
